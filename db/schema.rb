...
ActiveRecord::Schema.define(version: 2018_09_29_163043) do
  ...
  create_table "tenant_events", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tenant_id"], name: "index_tenant_events_on_tenant_id"
  end

  create_table "tenant_guests", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "tenant_events", "tenants"
  add_foreign_key "tenant_memberships", "tenant_users"
